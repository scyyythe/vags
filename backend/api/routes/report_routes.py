...
from api.views.admin.report_view import UndoReportView,BulkAuctionReportStatusView,ArtworkReportStatus,ExhibitReportStatus,BulkReportStatus,ReportStatus,ReportCreateView,AuctionReportStatus, UserReportsView, ReportDeleteView, ReportUpdateView, CommentReportStatus
...
report_urlpatterns = [
    ...
    path("artworks/<str:pk>/report-status/", ArtworkReportStatus.as_view(), name="artwork-report-status"),
    path("comments/<str:pk>/report-status/", CommentReportStatus.as_view(), name="comment-report-status"),
