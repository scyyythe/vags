...
class ReportSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if not any([art_id, auction_id, exhibit_id, reported_user_id]):
            raise serializers.ValidationError(
                "You must provide at least one of art_id, auction_id, exhibit_id, or reported_user_id."
            )
        return data
    ...
    def create(self, validated_data):
        ...
        art = auction = exhibit = reported_user = None
