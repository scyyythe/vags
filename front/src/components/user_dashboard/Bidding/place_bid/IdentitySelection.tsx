    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white rounded-2xl w-full max-w-xs mx-4 relative" onClick={(e) => e.stopPropagation()}>
        <div className="py-6 px-8">
          ...
          <p className="text-gray-500 text-[10px] mb-6">Your selected identity will be visible alongside your bid.</p>

          <div className="space-y-6 mb-8">
            {/* Anonymous Option */}
            <div
              className={`px-4 py-2 border rounded-full cursor-pointer transition-all ${
                selectedIdentity === "anonymous" ? "border-red-800 bg-red-50" : "border-gray-200 hover:border-red-300"
              }`}
            ...
            <div
              className={`px-4 py-2 border rounded-full cursor-pointer transition-all ${
                selectedIdentity === "username" ? "border-red-800 bg-red-50" : "border-gray-200 hover:border-red-300"
              }`}
            ...
            <div
              className={`px-4 py-2 border rounded-full cursor-pointer transition-all ${
                selectedIdentity === "fullName" ? "border-red-800 bg-red-50" : "border-gray-200 hover:border-red-300"
              }`}
