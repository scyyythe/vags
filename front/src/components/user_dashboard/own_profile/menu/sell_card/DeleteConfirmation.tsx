  ...
  if (!isOpen) return null;
   ...
   return ReactDOM.createPortal(
    ...
    onClick={(e) => e.stopPropagation()}>
      <div className="bg-white dark:bg-gray-800 rounded-lg py-7 px-8 shadow-xl max-w-sm w-full text-center relative"
      onClick={(e) => e.stopPropagation()}>
        <h2 className="text-xs font-semibold text-gray-900 dark:text-gray-100 mb-2">{deleteProductTitleText}</h2>
        <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-6">{deleteProductDescText}</p>
