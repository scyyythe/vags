    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            ...
            >
                ...
                <button
                    onClick={onClose}
                    className="absolute right-6 top-5 text-xl font-bold text-gray-800"
                >
                ...
                <div className="flex justify-center">
                    <img src={artwork.artworkImage} alt={artwork.title} className="w-36 h-32 object-cover rounded-lg" />
                </div>
