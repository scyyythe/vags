...
import useTopArtworks from "@/hooks/users/top_seller/useTopArtworks";
const mockArtworks = [
  {
...
export default function TopSellingArtworks() {
  ...
  const { data: sellers = [], isLoading } = useTopArtworks();
  return (
    <div className="p-4 md:p-10 max-w-7xl mx-auto">
      ...
      <div className="overflow-x-auto max-h-[70vh] overflow-y-auto text-sm">
        <Table>
          ...
          <TableBody>
            {(sellers.length > 0 ? sellers : mockArtworks).map((art: any, i: number) => (
