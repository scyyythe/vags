          ...
          <div className="lg:col-span-1">
            <div className="border border-border rounded-lg p-4 space-y-4">
              ...
              <div className="space-y-3 text-[10px]">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-[11px]">{order.orderDate}</p>
                  </div>
                </div>
              ...
              <div className="space-y-2 pt-4">
                <Button className="w-full text-[11px]" size="sm">
                  Contact Seller
                </Button>
                <Button variant="outline" className="w-full text-[11px]" size="sm">
                  Track Payment
                </Button>
                {order.status === "completed" && (
                  <Button variant="secondary" className="w-full text-[11px]" size="sm">
                    Leave Review
                  </Button>
                )}
              </div>
