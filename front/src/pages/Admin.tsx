    ...
    <section className="py-20 px-6 md:px-12 bg-black text-white">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <img src="/pics/8.jpg" alt="Humanoid Sculpture" className="w-full max-h-[500px] object-contain" />
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center space-x-3">
              <div className="w-9 h-9 rounded-full overflow-hidden">
                <img src="/pics/55.jpg" alt="Creator" className="w-full h-full object-cover" />
              </div>
              <div className="mb-2">
